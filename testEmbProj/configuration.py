...
Description: basic configuration used in the execution of test cases
"""

report_folder = './reports/'

dummy_text = "Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the " \
             ...
             "the years, sometimes by accident, sometimes on purpose (injected humour and the like).Where does it " \
             "come from? Contrary to popular belief, Lorem Ipsum is not simply random text. It has roots in a piece " \
